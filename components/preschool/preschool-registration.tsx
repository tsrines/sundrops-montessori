...
import { PRESCHOOL_REGISTRATION } from '@/lib/data/preschool-content';
...
export function PreschoolRegistration() {
  return (
        ...
        <div className="grid gap-12 md:grid-cols-2">
          <div>
            <h2 className="mb-2 text-sm font-semibold uppercase tracking-wider text-gray-800">
              {PRESCHOOL_REGISTRATION.heading}
            </h2>
            <p className="mb-4 font-serif text-2xl font-bold text-gray-800 md:text-3xl">
              {PRESCHOOL_REGISTRATION.subheading}
            </p>
            <p className="leading-relaxed text-gray-500">{PRESCHOOL_REGISTRATION.description}</p>
          </div>

          <div className="space-y-10">
            {PRESCHOOL_REGISTRATION.steps.map((step) => (
              <div key={step.number}>
