...
import { BRIDGE_HERO } from '@/lib/data/bridge-content';
...
export function BridgeHero() {
  return (
    <section className="relative flex min-h-[500px] w-full items-center justify-center overflow-hidden md:min-h-[600px]">
      <Image
        src="/images/campuses/bridge-campus-hero.jpg"
        alt="Bridge Campus Authentic Montessori Education in Mt. Pleasant, SC"
        fill
      ...
      <div className="relative z-10 container mx-auto max-w-4xl px-4 py-20 text-center">
        ...
        <p className="font-script mt-3 text-lg tracking-wider text-white md:text-xl">{BRIDGE_HERO.subtitle}</p>
        <div className="mt-8">
          <Button asChild size="lg" className="border border-black bg-white text-black hover:bg-white/90">
            <Link href={BRIDGE_HERO.cta.href}>{BRIDGE_HERO.cta.label}</Link>
          </Button>
        </div>
      </div>
    </section>
